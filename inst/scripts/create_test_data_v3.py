...
z = zarr.create_array('inst/extdata/zarr_examples/column-first/int32_v3.zarr', shape=(30, 20, 10),
               chunks=(10, 10, 5), dtype='i4', overwrite=True)
z[:] = 0
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 1

z = zarr.create_array('inst/extdata/zarr_examples/row-first/int32_v3.zarr', shape=(30, 20, 10),
               chunks=(10, 10, 5), dtype='i4', filters = (zarr.codecs.TransposeCodec(order = [2, 1, 0])), overwrite=True)
z[:] = 0
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 1
...
z3 = zarr.create_array('inst/extdata/zarr_examples/column-first/uint32_v3.zarr', shape=(30, 20, 10),
               chunks=(10, 10, 5), dtype='u4', overwrite=True)
z3[:] = 0
...
z4 = zarr.create_array('inst/extdata/zarr_examples/row-first/uint32_v3.zarr', shape=(30, 20, 10),
               chunks=(10, 10, 5), dtype='u4', filters = (zarr.codecs.TransposeCodec(order = [2, 1, 0])), overwrite=True)
z4[:] = 0
...
z = zarr.create_array('inst/extdata/zarr_examples/row-first/uint8_v3.zarr', shape=(30, 20, 10),
               chunks=(10, 10, 5), dtype='u1', filters = (zarr.codecs.TransposeCodec(order = [2, 1, 0])), overwrite=True)
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 1
...
z = zarr.create_array('inst/extdata/zarr_examples/column-first/int64_v3.zarr', shape=(30, 20, 10),
               chunks=(10, 10, 5), dtype='i8', overwrite=True)
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 1
z[29,19,9] = pow(2,32)
z[28,19,9] = pow(2,32)
...
z = zarr.create_array('inst/extdata/zarr_examples/row-first/int64_v3.zarr', shape=(30, 20, 10),
               chunks=(10, 10, 5), dtype='i8', filters = (zarr.codecs.TransposeCodec(order = [2, 1, 0])), overwrite=True)
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 1
z[29,19,9] = pow(2,32)
z[28,19,9] = pow(2,32)
...
z = zarr.create_array('inst/extdata/zarr_examples/column-first/uint64_v3.zarr', shape=(30, 20, 10),
               chunks=(10, 10, 5), dtype='u8', overwrite=True)
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 1
z[29,19,9] = pow(2,32)
...
z = zarr.create_array('inst/extdata/zarr_examples/column-first/string_v3.zarr', shape=(30, 20, 10),
               chunks=(10, 10, 5), dtype='|S6', fill_value = "", overwrite=True)

z[0, :, 0] = "test"
z[:, 0, 0] = "ready"

z = zarr.create_array('inst/extdata/zarr_examples/row-first/string_v3.zarr', shape=(30, 20, 10),
               chunks=(10, 10, 5), dtype='|S6', filters = (zarr.codecs.TransposeCodec(order = [2, 1, 0])), fill_value = "", overwrite=True)
...
z = zarr.create_array('inst/extdata/zarr_examples/column-first/float16_v3.zarr', shape=(30, 20, 10),
                chunks=(10, 10, 5), dtype='f2', overwrite=True)
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 10.52
z[0, 0, 0] = -1
...
z = zarr.create_array('inst/extdata/zarr_examples/row-first/float16_v3.zarr', shape=(30, 20, 10),
                chunks=(10, 10, 5), dtype='f2', filters = (zarr.codecs.TransposeCodec(order = [2, 1, 0])), fill_value = "0.0", overwrite=True)
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 10.52
z[0, 0, 0] = -1
## some denormalised examples
...
z = zarr.create_array('inst/extdata/zarr_examples/column-first/float32_v3.zarr', shape=(30, 20, 10),
                chunks=(10, 10, 5), dtype='f4', overwrite=True)
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 10.52

z = zarr.create_array('inst/extdata/zarr_examples/row-first/float32_v3.zarr', shape=(30, 20, 10),
                chunks=(10, 10, 5), dtype='f4', filters = (zarr.codecs.TransposeCodec(order = [2, 1, 0])), fill_value = "0.0", overwrite=True)
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 10.52
...
z = zarr.create_array('inst/extdata/zarr_examples/column-first/float64_v3.zarr', shape=(30, 20, 10),
                chunks=(10, 10, 5), dtype='f8', overwrite=True)
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 10.52

z = zarr.create_array('inst/extdata/zarr_examples/row-first/float64_v3.zarr', shape=(30, 20, 10),
                chunks=(10, 10, 5), dtype='f8', filters = (zarr.codecs.TransposeCodec(order = [2, 1, 0])), fill_value = "0.0", overwrite=True)
z[0, :, 0] = np.arange(start=1, stop=21)
z[:, 0, 0] = 10.52


z = zarr.create_array('inst/extdata/fill-values/double-inf_v3.zarr', shape=(20, 10),
              chunks=(10, 10), dtype='f8', filters = (zarr.codecs.TransposeCodec(order = [1, 0])), fill_value = "Infinity", overwrite=True)
z[0, :] = 1
...
z = zarr.create_array('inst/extdata/zarr_examples/column-first/boolean_v3.zarr', shape=(20, 10),
               chunks=(10, 10), dtype='b1', overwrite=True)
z[0, :] = 1
...
z = zarr.create_array('inst/extdata/zarr_examples/compression/zlib_v3.zarr', shape=(20, 10),
              chunks=(10, 10), dtype='i4', filters = (zarr.codecs.TransposeCodec(order = [1, 0])), compressors=compressor, overwrite=True)
...
z = zarr.create_array('inst/extdata/zarr_examples/column-first/Unicode_v3.zarr', shape=(12, 12),
              chunks=(6, 6), fill_value = "", dtype='U20', overwrite=True)
z[:,0] = greetings
z[0,:] = greetings

z = zarr.create_array('inst/extdata/zarr_examples/column-first/vlenUTF8_v3.zarr', shape=(12, 12),
              chunks=(6, 6), fill_value = "", dtype=str, overwrite=True)
z[:,0] = greetings
z[0,:] = greetings
...
group = zarr.create_group(
    "inst/extdata/zarr_examples/metadata/zarr_examples/consolidated_v3.zarr", overwrite=True
)
...
# Scalar
z = zarr.create_array('inst/extdata/zarr_examples/scalar/scalar_v3.zarr', shape=(), dtype='i4', overwrite=True)
z[()] = 42
...
z = zarr.create_array('inst/extdata/zarr_examples/structured/structured_v3.zarr', shape=(10,2), chunks=(5,2), dtype=Struct.from_native_dtype(dt), overwrite=True)
