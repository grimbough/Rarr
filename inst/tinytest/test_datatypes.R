...
expect_equal(
  .check_datatype(data_type = "character", nchar = "10")[["data_type"]],
  "|S10"
)
...
expect_equal(
  .check_datatype(data_type = "integer", fill_value = 4)[["data_type"]],
  "<i4"
)
expect_equal(
...
expect_equal(
  .check_datatype(data_type = "character", fill_value = 4L, nchar = 4)[[
    "data_type"
  ]],
  "|S4"
)
