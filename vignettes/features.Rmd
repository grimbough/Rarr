...
It is known that only reading, and writing via `update_zarr_array()`, are currently supported and that the sharding codec is not yet implemented.
...
|`Unicode`            | &#x2714; / &#x2714; | |
|`void *`             | &#x274C; / &#x274C; | |
| Structured data types | &#x2714; / &#x274C; | Only one level of nesting and no arrays for now. |
